 ...
 * @author farooq
 */
public class ContactsUI extends javax.swing.JFrame implements ContactForm.ContactFormListener {
     ...
     */
    public ContactsUI(ArrayList<Contact> c) {        
        initComponents();
    ...
    @Override
    public void contactSaved(Contact c) {        
        model.update();        
    }
    ...
    private class ContactsTableModel extends AbstractTableModel{
        ...
        private final String[] columnNames = {"First Name","Last Name","Email","Contact No."," "};
        
        public ContactsTableModel(ArrayList<Contact> c){
            contacts = c;
            if (contacts == null){
