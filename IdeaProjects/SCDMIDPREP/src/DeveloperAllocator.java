...
public class DeveloperAllocator {
    ...
    public static class Task  // tasks to perform as a dev
    {
        ...
        public Task(String taskName, Map<String, String> taskSkills) {
            this.name = taskName;
            this.mustHaveSkills = taskSkills;
        }
    ...
    public static class Resource {
        ...
        public Resource(String resourceName, List<Skill> skills) {
...
//
//    public static List<Resource> readDevelopers(String input) throws Res_IOException {
//        List<Resource> developers = new ArrayList<>();
//
//        String[] lines = input.split("\n");
//        for (String line : lines) {
//            String[] parts = line.split("\\|");
//            String devName = parts[0].trim();
//            String[] devSkills = parts[1].split(",");
//            Resource developer = new Resource(devName);
//
//            for (String skilly : devSkills) {
//                String[] skillParts = skilly.trim().split(":");
//                String skillName = skillParts[0].trim();
//                int expYears = Integer.parseInt(skillParts[1].trim());
//                Skill skill = new Skill(skillName, expYears);
...
//    }
//
//    public static List<Task> readTasks(String input) throws Res_IOException {
...
//            String[] skillerData = parts[1].split(",");
//            Task task = new Task(taskName);
//
//            for (String skillData : skillerData) {
//                String[] skillParts = skillData.trim().split(":");
//                String skillName = skillParts[0].trim();
//                String skillLvl = skillParts[1].trim();
//                task.addMustSkill(skillName, skillLvl);
//            }
//
//            tasks.add(task);
//        }
...
//    }
//
//    // Add another method to allocate developers to tasks:
//    public static String allocateDevelopersToTasks(List<Resource> developers, List<Task> tasks) {
...
//
//        for (Task task : tasks) {
//            result.append("Task |  ").append(task.getName()).append("\n");
//            result.append("Based on Skill, Could be allocated to Developer(s)::\n");
//            for (Resource dev : developers) {
...
//    }
    ...
    public static void main(String[] args) {
        ...
        try { // file reading as java.io.*
            ...
            try (BufferedReader devSkillReader = new BufferedReader(new FileReader("resources.txt"))) {
            ...
            } catch (IOException e) {  // customized exception thrown
